...
aarch64-linux-gnu-ld -nostdlib -T link.lds -o kernel.elf init_blob.o boot.o main.o liba.o lib.o uart.o print.o debug.o handlera.o handler.o mmu.o  memory.o file.o process.o syscall.o 
