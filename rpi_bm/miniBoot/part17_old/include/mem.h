...
#define PTE_TYPE_PAGE   (0UL << 1)   // Final-level descriptor (PTE)
...
#define USER_FLAGS_CODE  (0x7c5)// (PTE_VALID |  PTE_ATTRINDX(1)|PTE_TYPE_PAGE | PTE_USER_RDONLY | PTE_SHARED | PTE_AF | PTE_NG | (MT_NORMAL << 2))
#define USER_FLAGS_DATA  0x7c5// (PTE_VALID |  PTE_ATTRINDX(1)|PTE_TYPE_PAGE | PTE_USER_RW | PTE_SHARED | PTE_AF | PTE_NG | (MT_NORMAL << 2))
...
#define USER_CODE_BASE      0x300000        // 用户代码起始虚拟地址
