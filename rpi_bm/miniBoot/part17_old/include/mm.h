...
#define LINEAR_MAP_BASE KERNEL_VIRT_OFFSET //0xfffff80000000000
...
#define LOW_MEMORY     (2 * SECTION_SIZE) //(4*2 * SECTION_SIZE)=4*4MB (0x00400000)  //#define LOW_MEMORY 0x40000 //jimmy chang to 0x80000
